...
.sdt-today-btn:focus, .sdt-today-btn:active, .sdt-today-btn:hover:not([disabled]) {
...
.sdt-clear-btn:focus, .sdt-clear-btn:active:not([disabled]), .sdt-clear-btn:hover:not([disabled]) {
